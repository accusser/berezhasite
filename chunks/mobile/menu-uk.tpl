    <div class="offcanvas offcanvas-start suha-offcanvas-wrap" tabindex="-1" id="suhaOffcanvas" aria-labelledby="suhaOffcanvasLabel">
      ...
      <div class="offcanvas-body">
        ...
        [[pdoMenu?
        	&level=`1`
        	&parents=`0`
        	&resources=`-15948,-12654`
        	&tplOuter=`@INLINE <ul class="sidenav-nav ps-0">[[+wrapper]]</ul>`
        	&tplParentRow=`@INLINE <li class="suha-dropdown-menu"><a href="[[+link]]" [[+attributes]]>[[+menutitle]]</a>[[+wrapper]]</li>`
        ]]
          <div class="form-check form-switch mb-0" style="padding-left: 3.4em;">
            <label class="form-check-label text-white h6 mb-0" for="darkSwitch">Темний режим</label>
            <input class="form-check-input" id="darkSwitch" type="checkbox" role="switch">
          </div>    
          <hr>
<div class="form-check mb-0" style="padding-left: 1em;">
                <ul class="sales-end-timer ps-0 d-flex align-items-center text-white">
