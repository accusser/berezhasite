...
<title>{$_modx->getPlaceholder('sf.title')?: $_modx->resource.longtitle?: $_modx->resource.pagetitle} [[!get_post]] | {$_modx->config.site_name}</title>
    

    {if $primaryDescription}
        <meta name="description" content="[[+primaryDescription]] [[!get_post]]">
    {else}
