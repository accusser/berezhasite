<form class="col-md-8 mx-auto col-12 ms2_form" id="msOrder" method="post">
    <div class="row">
        ...
        <div class="col-12 col-md-6" id="payments" hidden>
    ...
    <div class="row">
        <div class="col-12 col-md-6" id="deliveries" hidden>
    ...
    <div class="form-submit text-right d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-end mb-5">
...
<div class="btn-wrapper position-relative d-inline-block">
        <button type="submit" name="ms2_action" class="btn btn-warning" value="order/submit">{'ms2_frontend_order_submit' | lexicon}</button>
</div>          
<!--div class="btn-wrapper position-relative d-inline-block">
        <button type="submit" name="ms2_action" style="padding: 0 1.2rem 0 1.2rem;" value="order/submit" class="submit-input-rounded text-white font-weight-bold text-uppercase text-nowrap border-0 ms2_link">
