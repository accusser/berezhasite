...
<div class="article-section container py-5">
  ...
  <div class="row">
    <ul class="buttons-wrapper">
      ...
      {include 'file:chunks/navcat-ru.tpl'}
      {else}
      {include 'file:chunks/navcat-uk.tpl'}
      {/if}
    </ul>
  </div>
  {'!mFilter2' | snippet : [
  ...
  'tplFilter.outer.price' => '@FILE chunks/catalog/myFilterSlider.tpl',
  'tplFilter.row.price' => '@FILE chunks/catalog/myFilterNumber.tpl',
  ]}
  {if $_modx->getPlaceholder('sf.content')?:$_modx->resource.content}
  <div class="bg2">
    <article class="article-section container">
      <div class="row py-5">
        <div class="article-content scroll-content col-12 col-md-10 mx-auto sf_content">
