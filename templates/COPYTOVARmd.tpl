                            ...
                            <div class="row">
                                <div class="col-xl-9 col-md-12 section-header mb-4 text-left">
                                    <h1 class="section-header mb-4 text-left">
                                        <span class="superheader"> [[pdoField? &id=`[[*id]]` &top=`2` &topLevel=`2`]] {$brand}</span>[[pdoField? &id=`[[*id]]` &top=`2` &topLevel=`3`]] [[pdoField? &id=`[[*id]]` &top=`2` &topLevel=`4`]]
                                        Модель {$_modx->resource.pagetitle}
                                    </h1>
                                </div>
                                <div class="col-xl-3 col-md-12 section-header mb-4 text-right">
                                    [[!ecThreadRating? &thread=`resource-[[BabelTranslation? &resourceId=`[[*id]]` &contextKey=`uk`]]` ]]
                                    <small style="float: right;">
                                        [[!++reviews]] ([[!ecMessagesCount? &thread=`resource-[[BabelTranslation? &resourceId=`[[*id]]` &contextKey=`uk`]]` ]]) / <a href="[[~[[*id]]]]#review">[[!++addrev]]</a>
                                    </small>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-sm-6 col-lg-6">
                                    ...
                                    <p class="product-page-price font-weight-bold py-3">
                                        [[-!+kursv:is=`1`:then=`[[-!+price:replace=` ==`:mpy=`[[-!++kurs]]`]]`:else=`[[-!+price]]`]] [[!+price]] грн.
                                    </p>
    ...
    >
        Купить в 1 клик    </button>                                            
                                            <!--button
                                                type="button"
                                                id="purchase-btn"
                                                class="product-to-cart shk-but text-md-left"
                                                data-no="{$_modx->lexicon('localizator_no')}"
                                                data-bs-toggle="modal"
                                                data-toggle="modal"
                                                data-bs-target="#oneclick"
                                                onclick="fillmodal()"
                                            >
                                                [[!++oneclick]]
                                            </button-->
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 offset-xl-2">
   <button class="button button--gradient js-import button--sm _import-pending _import-loaded _import-executed" title="Вызов замерщика" rel="nofollow" type="button" data-fancybox="" href="#zamer-call">
                                    Вызов замерщика
                                </button>                                         
                                    </div>
{else}
    ...
    >
        Купити в 1 клік    </button> 
                                    ...
                                    <div class="col-xl-5 col-lg-6 col-md-12 col-sm-12 offset-md-0">
   <button class="button button--gradient js-import button--sm _import-pending _import-loaded _import-executed"rel="nofollow" type="button" data-fancybox="" href="#zamer-calluk">
                                    Виклик замірника
    </button>                                         
                                    </div>
{/if}                               
...
<section class="regular slider container">
             {'msProducts' | snippet : [
        		'tpl' => '@FILE chunks/catalog/TovarSlider.tpl',
        		'limit' => '20',
