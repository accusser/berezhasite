                        ...
                        <div class="col-xl-8 col-md-8 product-page-info">
                          ...
                          <div class="row">
                            ...
                            <div class="col-12 col-sm-6 col-lg-6">
                              ...
                              [[+price:is=`0`:then=`[[*context_key:is=`web`:then=`Цена по запросу`:else=`Ціна за запитом`]] `:else=`{$price} грн.`]]        
                		...
                		'tpl' => '@FILE chunks/catalog/msOptionsTags.tpl',
                          ...
                          <div class="row">
                            ...
                            {if $_modx->resource.dverBlok_vhod != ''}
                                  <div class="select-block mb-3">
                                    <p class="font-weight-bold text-uppercase text-nowrap ti-0 mb-0">[[++LOCALIZATOR_LZ_DVERNOBLOCK]]</p>
                            ...
                            <div class="col-12 col-sm-6">
                                  <div class="select-block mb-3">
                                    <p class="font-weight-bold text-uppercase text-nowrap ti-0 mb-0">[[++localizator_lz_komplektation]]</p>
                                      {$_modx->runSnippet('uk_render_select', [
...
<div class="container-fluid bg3 pb-1 pb-lg-0 position-relative menurow d-none d-lg-block">
        <div class="container">
          <div class="row justify-content-between ">
              Доступные цвета
            <nav class="col-xl-10 col-12 text-center px-0 py-4 d-lg-flex d-none position-static">
