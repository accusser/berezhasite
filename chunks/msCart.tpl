<div id="msCart">
    ...
    <div class="table-responsive">
        <table class="table table-striped">
            ...
            {var $image}
            {if $product.thumb?}
            <img src="{$product.thumb}" alt="{$product.pagetitle}" title="{$product.pagetitle}" width="150" />
            {else}
            <img src="{'assets_url' | option}components/minishop2/img/web/ms2_small.png"
                srcset="{'assets_url' | option}components/minishop2/img/web/ms2_small@2x.png 2x"
                alt="{$product.pagetitle}" title="{$product.pagetitle}" / width="150">
            {/if}
            {/var}
            <tr id="{$product.key}">
                <td class="ms-title">
                    <div class="d-flex">
                        ...
                        <div class="minicart-product-name title" style="padding-top: 50px;">
                            {if $product.id?}
                ...
                <td class="ms-count">
                    <form method="post" class="ms2_form" role="form" style="padding-top: 50px;">
                        ...
                        <div class="form-group">
                            ...
                            <button class="btn btn-sm" type="submit" name="ms2_action"
                ...
                <td class="ms-price" style="padding-top: 50px;">
                ...
                <td class="ms-cost" style="padding-top: 50px;">
                    <span class="mr-2 text-nowrap"><span class="ms2_cost">{$product.cost}</span>
                        {'ms2_frontend_currency' | lexicon}</span>
                </td>
                <td class="ms-remove" style="padding-top: 50px;">
                    <form method="post" class="ms2_form text-md-right">
                        <input type="hidden" name="key" value="{$product.key}">
                        <button class="btn btn-sm btn-danger" type="submit" name="ms2_action"
                            value="cart/remove">&times;</button>
                    </form>
                </td>
            </tr>
            {/foreach}
