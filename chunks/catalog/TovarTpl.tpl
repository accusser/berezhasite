<div class="ms2_product col-6 col-sm-6 col-md-4 mb-3 px-2" id="msProduct">
    ...
    <div class="product text-center">
      <a href="{$uri}" class="clr3" title="{$_modx->resource.pagetitle} {$pagetitle}">
        <picture>
          ...
          <img src="{$thumb}" alt="{$_modx->resource.pagetitle} {$pagetitle}"
            title="{$_modx->resource.pagetitle} {$pagetitle}" class="lazy img-fluid">
        </picture>
        <div class="flags ">
          {if $new?}
      ...
      <div class="product-info">
        ...
        {set $thread = 'BabelTranslation' | snippet : [
        'resourceId' => $id,
        'contextKey' => 'uk'
        ]}
        ...
        <a href="{$uri}" class="product-link"
          title="{$_modx->resource.pagetitle} {$pagetitle}">{'ms2_frontend_add_to_cart' | lexicon}</a>
      </div>
    </div>
  </form>
</div>