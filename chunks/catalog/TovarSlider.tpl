              ...
              <div class="product text-center">
                ...
                <a href="{$uri}" class="clr3" title="{$_modx->resource.pagetitle} {$pagetitle}">
                    ...
                    <picture>
                        ...
                        <img src="{$thumb}" alt="{$_modx->resource.pagetitle} {$pagetitle}" title="{$_modx->resource.pagetitle} {$pagetitle}" class="lazy img-fluid" style="display: inline-block;">
                    </picture>
